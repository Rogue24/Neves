...
+ (instancetype)sharedInstance {
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedInstance_ = [[JPPhotoTool alloc] init];
    });
    return sharedInstance_;
}
...
//        count = [fetchResult countOfAssetsWithMediaType:PHAssetMediaTypeImage]; // 获取照片总数量（也可以指定其他类型）
