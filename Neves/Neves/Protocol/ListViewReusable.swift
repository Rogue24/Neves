...
extension UITableView {
    ...
    func registerHeaderFooterView<T: UITableViewHeaderFooterView>(_ viewClass: T.Type) where T: CellReusable {
        if let nib = T.nib {
...
extension UICollectionView {
    ...
    func registerSectionHeader<T: UICollectionReusableView>(_ headerClass: T.Type) where T: CellReusable {
        if let nib = T.nib {
    ...
    func registerSectionFooter<T: UICollectionReusableView>(_ headerClass: T.Type) where T: CellReusable {
        if let nib = T.nib {
    ...
    func dequeueReusableSupplementaryView<T: UICollectionReusableView>(ofKind kind: String, for indexPath: IndexPath) -> T where T: CellReusable {
