...
internal enum Asset {
  ...
  internal static let roomguideEmojiKuolie = NevesImageAsset(name: "roomguide_emoji_kuolie")
  internal static let roomguideEmojiTingjian = NevesImageAsset(name: "roomguide_emoji_tingjian")
  internal static let roomguideEmojiXiangqin = NevesImageAsset(name: "roomguide_emoji_xiangqin")
  internal static let roomguideEmojiZudui = NevesImageAsset(name: "roomguide_emoji_zudui")
